    ...
    <div className="container">
      <section className="hero">
        <div className="hero-background">
          <img src={img8} alt="Безопасность" className="hero-background-img" />
        </div>
        <div className="hero-content">
          <h1>
            Приложение для <br /> всей <br /> безопасности <br /> детей и женщин!
          </h1>
        </div>
        <div className="hero-image">
          <img src={img1} alt="Безопасность" className="hero-image-img" />
        </div>
      </section>
      ...
      <section className="features">
        <div className="feature">
          <div className="horizontal">
            <h2>Cлужебная помощь</h2> <span>1</span>
          </div>
          <p>
            Для экстренных случаев <br /> воспользуйтесь услугами <br /> служебной помощи
          </p>
        </div>
        <div className="feature">
          <div className="horizontal">
            <h2>Для семьи</h2> <span>2</span>
          </div>
          <p>
            Можете пользоваться нашим <br /> приложением со всей семьей, для <br /> отслеживания
            геолокации итд
          </p>
        </div>
        <div className="feature">
          <div className="horizontal">
            <h2>График дня</h2> <span>3</span>
          </div>
          <p>
            Можете пользоваться нашим <br /> приложением со всей семьей, для <br /> составления
            графика дня
          </p>
        </div>
      </section>
      ...
      <section className="safety">
        <div className="safety-image left">
          <img src={img2} alt="Человек с телефоном" className="safety-image-left" />
        </div>
        <div className="safety-image-righter">
          <img src={img9} alt="Айфон с приложением SafeJurt" className="safety-image-righter" />
        </div>
      ...
      <section className="registration">
        ...
        <div className="registration-image right">
          <img src={img14} alt="Айфон с приложением SafeJurt" className="registration-image-right" />
        </div>

        <div className="registration-image left">
          <img src={img3} alt="Человек с телефоном" className="registration-image-left" />
        </div>
      </section>

      <section className="safety">
        <div className="safety-image left">
          <img src={img7} alt="Человек с телефоном" className="safety-image-left" />
        </div>
        <div className="safety-image right">
          <img src={img9} alt="Айфон с приложением SafeJurt" className="safety-image-right" />
        </div>
        <div className="safety-content">
          <h2>Пользователи</h2>
          ...
          <p>Настроивают геолокацию и параметры безопасности.</p>
      ...
      <section className="registration">
        ...
        <div className="registration-image right">
          <img src={img12} alt="Айфон с приложением SafeJurt" className="registration-image-right" />
        </div>

        <div className="registration-image left">
          <img className="registration-image-left" src={img6} alt="Человек с телефоном" />
        </div>
      </section>

      <section className="safety">
        <div className="safety-image left">
          <img className="feature-image" src={img5} alt="Человек с телефоном" />
        </div>
        <div className="safety-image right">
          <img className="feature-image" src={img11} alt="Айфон с приложением SafeJurt" />
        </div>
        <div className="safety-content">
      ...
      <section className="registration">
        ...
        <div className="registration-image right">
          <img className="safety-image" src={img10} alt="Айфон с приложением SafeJurt" />
        </div>

        <div className="registration-image left">
          <img className="registration-image" src={img4} alt="Человек с телефоном" />
        </div>
      </section>
